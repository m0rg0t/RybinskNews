...
Адрес: г. Рыбинск,  Крестовая ул., д.4-10; Соборная площадь, д. 4; Волжская наб., д.67-75;  Красная пл., д.3",
            ...
            tourist.Items.Add(new MapItem("Group-15-Item-1",
                "Усть-Шексна",
                "",
                "Assets/ust-weksna.jpg",
                "Усть-Шексна",
                @"Усть-Шексна – археологическая реликвия города Рыбинска.
Кратко:
На правом берегу Шексны, при впадении её в Волгу находится памятник археологии «Усть-Шексна». Здесь, к 935-летию о первом летописном упоминании Усть-Шексны возведён памятный знак – стилизованная сторожевая башня с частоколом.
Построенная на месте аналогичного строения XII века, эта архитектурная доминанта не только украшает знаменитое Устье, но является первым этапом создания интерактивного археологического музея, будущим центром туризма.",
                tourist, 58.06718, 38.83117));

            tourist.Items.Add(new MapItem("Group-16-Item-1",
                "Дом соборного притча",
                "",
                "Assets/dom-sobornogo-pritcha.jpg",
                "Дом соборного притча",
                @"Соборная площадь это не только Спасо-Преображенский собор и мост через Волгу, здесь расположен еще один наиважнейший памятник архитектуры местного значения -  Дом соборного причта (1811 год).
Здание было построено в формах старого классицизма за два десятилетия до начала возведения главного храма Рыбинска. В 1851 году, дабы священники со своими семьями могли проживать неподалеку от места службы, настоятель Спасо-Преображенского собора отец Родион Путятин приобрел его в церковную собственность.
Сегодня дом № 7 на Крестовой знают как дом, где проживал священнослужитель Спасо-Преображенского собора Алексей Золотарев и его пятеро талантливых детей (Алексей, Сергей, Давид, Николай и Мария). Несмотря на то, что дети Алексея Золотарева обучались в Сорбонне, Санкт-Петербурге и много работали за границей, никогда не забывали свой родной город.
Особенно большую роль в культурном развитии и духовном процветании Рыбинска сыграл Алексей Алексеевич. Он лично был знаком с А.М. Горьким, Ф.И. Шаляпиным, И.А. Буниным, писал рассказы, работал библиотекарем на Капри. В 1918 году он возглавил научное общество.
В дальнейшем в Доме соборного причта проживали знаменитый востоковед Николай Невский и священнослужитель и один из организаторов работы обсерватории в Рыбинске Александр Образцов.
Сегодня Дом соборного причта передан Русской Православной Церкви.
Адрес: Ярославская область, г. Рыбинск,  Крестовая ул., д. 7;",
                tourist, 58.04781, 38.85811));


            tourist.Items.Add(new MapItem("Group-17-Item-1",
                "Фёдор Фёдорович Ушаков",
                "",
                "Assets/uhakov-letom.jpg",
                "Фёдор Фёдорович Ушаков",
                @"Фёдор Фёдорович Ушаков (1743-1817) – великий русский флотоводец. В историю военно-морского флота Ф. Ушаков вошёл как «непобедимый адмирал». Ни один российский корабль под его командованием не был потерян. Ни один матрос не попал в плен к врагу. участвовал в 43 сражениях и ни одного не проиграл.
Однако Ушаков снискал славу не только как военный. Свою первую награду – орден святого Владимира 4 степени — он получил за умелые действия и за заботу о матросах во время борьбы с эпидемией чумы в Херсоне.
Памятник Ф. Ушакову установлен в Рыбинске 27 июля 1996 года. С 2001 года 15 октября ежегодно отмечается День памяти адмирала Ф. Ф. Ушакова. В селе Хопылёво сохранился храм – Церковь «Богоявления на Острову» (1701), где был крещён Федор Ушаков.",
                tourist, 58.04933, 38.85248));
